...
// Use a shared resolver (scripts/cache-env.js) so scripts and server agree on
// which environment variables to check. This keeps behavior consistent across
// scripts and runtime.
// Note: require() is fine here because the resolver is a small CommonJS module.
const { getRedisUrl } = require('../../scripts/cache-env')
