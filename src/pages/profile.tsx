                      ...
                      <div style={{ 
                        ...
                        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '16px' }}>
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            ...
                            />
                            <select
                              value={String(formData.property_type_id || '')}
                              onChange={(e) => setFormData(prev => ({ ...prev, property_type_id: parseInt(e.target.value, 10) || 0 }))}
                              required
                              style={{
                                padding: '12px 16px',
                                border: '1px solid #d1d5db',
                            ...
                            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                              ...
                              <div style={{
                                ...
                                <button 
                                  type="button"
                                  onClick={() => {
                                    const newValue = Math.min((formData.bedrooms || 0) + 1, 20);
                                    setFormData(prev => ({ ...prev, bedrooms: newValue }));
                                  }}
                                  style={{
                                    width: '40px',
                                    height: '18px',
                                ...
                                <button 
                                  type="button"
                                  onClick={() => {
                                    const newValue = Math.max((formData.bedrooms || 0) - 1, 0);
                                    setFormData(prev => ({ ...prev, bedrooms: newValue }));
                                  }}
                                  style={{
                                    width: '40px',
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
                            ...
                            <input
                              ...
                              onChange={(e) => setFormData(prev => ({ ...prev, sq_meters: parseInt(e.target.value) || 0 }))}
                              required
                              min="0"
                              style={{
                                padding: '12px 16px',
                            ...
                            />
                            <select
                              value={String(formData.property_status_id || '')}
                              onChange={(e) => setFormData(prev => ({ ...prev, property_status_id: parseInt(e.target.value, 10) || 0 }))}
                              required
                              style={{
                                padding: '12px 16px',
                                border: '1px solid #d1d5db',
